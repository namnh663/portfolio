...
const PerformingAPITesting = () => {
  return (
    <div className="article-detail">
      ...
      <h3>1. Understand the API Specifications</h3>
      <ul>
      ...
      <h3>2. Set Up the Test Environment</h3>
      <ul>
      ...
      <h3>5. Analyze and Report Results</h3>
      <ul>
      ...
      <h3>7. Continuous Integration</h3>
      <ul>
